                    ...
                    <div class="card-body is-form">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <input class="form-control db-edit-modal__input" v-model="name" name="name" type="text" value="">
                        ...
                        <!--<div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <input class="form-control db-edit-modal__input" name="email" type="mail" value="">
                            </div>
                        </div>-->
                        <div class="form-row">
                            <div class="form-group col-12">
                                <label class="form-control__label">Телефон</label>
                                <input class="form-control db-edit-modal__input js-input-phone-mask" v-model="phone" name="phone" type="tel" value="" placeholder="+380 (**) *** ** **" maxlength="19">
                        ...
                        <div class="form-row">
                            <div class="form-group col-12">
                                ...
                                <input class="form-control db-edit-modal__input" v-model="password" name="password" type="text" value="">
                        ...
                        <div class="row">
                            <div class="col-12 text-center">
                                ...
                                <button type="submit" class="btn btn-outline-primary js-send-new-account" data-attach-loading="">
                                    Отправить запрос <span class="icon-is-arrow icon-is-right"></span>
                                </button>
                                <!-- modal new user -->
                                <div class="modal db-modal fade" id="new-account" tabindex="-1" role="dialog" aria-hidden="true"><!-- --2 -->
