<template>
    <v-content v-if="isLoaded">
        <template v-slot:sidebar>
            <project-list-sidebar :options="project.project.options" :status="project.project.status"
        ...
        <div class="dashboard">
            <div class="dashboard-head">
                <div class="dashboard__title" v-if="project.project.options">
                    <cover :image="project.project.options.files.cover.path" :title="project.project.options.title"
                           class="dashboard__title-logo"/>
                ...
                <div class="dashboard_main-head">
                    ...
                    <div class="dashboard_main__status">
                        ...
                        <div class="dashboard_main__status-content">
                            <p class="dashboard_main__status-description">
                                {{ percentActive(project.status_active, project.user_total) }}% выполненых</p>
                            <div class="dashboard_main__status-line">
                                <span
                                    :style="'width:'+percentActive(project.status_active, project.user_total)+'%;'"></span>
                            </div>
                    ...
                    <div class="dashboard_main-info">
                        <div class="dashboard_main__item">
                            <div class="dashboard_main__item-wrap">
                                <p class="dashboard_main__item-status dashboard_main__item-status--green"><span>Выполнили активности</span>
                                </p>
                                <p class="dashboard_main__item-quantity">{{ project.status_active }}</p>
                                <input type="hidden" id="project_status_active"
                                       :value="(project.status_active)?project.status_active:0"/>
                            </div>
                            <users-popup :title="'Выполнили активности'" id="status_active" index="1"
                                         v-if="project.status_active" :project_id="project.project.id"/>
                        </div>
                        <div class="dashboard_main__item">
                            <div class="dashboard_main__item-wrap">
                                <p class="dashboard_main__item-status dashboard_main__item-status--red"><span>Не выполнили активности</span>
                                </p>
                                <p class="dashboard_main__item-quantity">{{ project.status_not_active }}</p>
                                <input type="hidden" id="project_status_not_active"
                                       :value="(project.status_not_active)?project.status_not_active:0"/>
                            </div>
                            <users-popup :title="'Не выполнили активности'" id="status_not_active" index="0"
                                         v-if="project.status_not_active" :project_id="project.project.id"/>
                        </div>
                        <div class="dashboard_main__item">
                            <div class="dashboard_main__item-wrap">
                                <p class="dashboard_main__item-status dashboard_main__item-status--blue"><span>Не участвовали</span>
                                </p>
                                <p class="dashboard_main__item-quantity">{{ project.status_not_participate }}</p>
                                <input type="hidden" id="project_status_not_participate"
                                       :value="(project.status_not_participate)?project.status_not_participate:0"/>
                            </div>
                            <users-popup :title="'Не участвовали'" id="status_not_participate" index="2"
                                         v-if="project.status_not_participate" :project_id="project.project.id"/>
                        </div>
                    </div>
                </div>
            </div>
            <div class="dashboard_study" v-if="project.content">
                ...
                <div class="dashboard_study-box flex-row" v-for="(content, key) in project.content">
                    ...
                    <div class="row">
                        ...
                        <div class="dashboard_study__block" v-if="content.fullTest">
                            <div class="dashboard_study__block-head">
                                <p class="dashboard_study__block-title">Тесты</p>
                                <test-popup :id="key" :content_id="content.id"
                                            :project_id="project.project.id"
                                            :test="content.fullTest"
                                            :tests="content.fullTest.complex"
                                            :passing_tests="project.passing_tests"/>
                            </div>
                            <div class="dashboard_study__status">
                                <div class="dashboard_main__status-content width-100">
                                    <p class="dashboard_main__status-description">
                                        {{ percentActive(content.test_status_active, project.user_total) }}%
                                        выполненых</p>

                                    <div class="dashboard_main__status-line">
                                        <span
                                            :style="'width:'+percentActive(content.test_status_active, project.user_total)+'%;'"></span>
                                    </div>
                                    <p class="dashboard_main__status-description">{{ project.user_total }}
                                        активностей</p>
                                </div>
                            </div>
                        ...
                        <div class="dashboard_study__block " v-if="content.fullArticle">
                            <div class="dashboard_study__block-head width-full space-between">
                                <p class="dashboard_study__block-title">Статьи</p>
                            </div>
                            <div class="dashboard_study__status">
                                <div class="dashboard_main__status-content width-100">
                                    <p class="dashboard_main__status-description">
                                        {{ percentActive(content.article_status_active, project.user_total) }}%
                                        выполненых</p>
                                    <div class="dashboard_main__status-line">
                                        <span
                                            :style="'width:'+percentActive(content.article_status_active, project.user_total)+'%;'"></span>
                                    </div>
                                    <p class="dashboard_main__status-description">{{ project.user_total }}
                                        активностей</p>
                                </div>
                            ...
                            <div class="dashboard_study__info">
                                ...
                                <div class="dashboard_study__info-block">
                                    <p class="dashboard_study__info-data">{{
                                            content.article_status_not_participate
                                        }}</p>
                                    <users-popup
                                        :title="'Не участвовали'"
                                        classButton="dashboard_study__info-button"
