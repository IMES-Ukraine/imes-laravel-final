<template>
    <v-content>
        ...
        <div class="main-articles">
            <div class="article-edit card">
                ...
                <h4>Создание пакета контента</h4>
                <br>
                <div class="card-body">
                    <div class="row mb-4">
    ...
    &nbsp;Создать новую
                                ...
                                <input type="button" name="addCover" id="add-cover" class="input-file-hidden" @click="addArticle">
                            </label>
                        </div>
                        <div class="col-2">
                                <div class="row">
...
export default {
    ...
    data() {
        return {
            ...
            testPoints: this.$store.state.tests[0].points,
