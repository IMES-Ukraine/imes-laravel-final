<template>
    <div>
        <div class="card-body">
            ...
            <div class="row mb-4">
                    ...
                    <div class="col-4">
                        <label class="btn btn-outline-second btn-centered-content upload-cover is-small">
                          <span class="input-file-label">
                            <span class="icon-is-left icon-is-load-grey"></span><span v-if="video">{{ video.file_name }}</span><span v-else>Завантажити</span>
                          </span>
                ...
                <template v-else>
                    ...
                    <div class="col-4">
                        <label class="btn btn-outline-second btn-centered-content upload-cover is-small">
                          <span class="input-file-label">
                            <span class="icon-is-left icon-is-load-grey"></span><span v-if="cover">{{ cover.file_name }}</span><span v-else>Завантажити</span>
                          </span>
            ...
            <!--            <SimpleTestVariants @file_сhange="handleUpload" v-bind:answer="answer" v-bind:variants="variants"></SimpleTestVariants>-->
...
export default {
    ...
    methods: {
        ...
        handleUpload( event) {
            ...
            this.$post(process.env.VUE_APP_API_URI + '/project/image/' + type,
                imageForm,
                {
                    headers: {
